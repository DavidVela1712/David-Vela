...
## 🛠️ Habilidades / Tecnologías & Qué me gusta trabajar  
- **Lenguajes / Frameworks / Librerías**: Python, Flask, React, Angular, Java, JavaScript.  
- **Control de versiones**: Git / GitHub, buenas prácticas en commits, forks, repos bien organizados.  
- **Interés general**: aprender, colaborar, experimentar — cada repo es una oportunidad para crecer.  

## 🎯 Qué busco / Qué me motiva  
- Seguir aprendiendo y sumando experiencia real en proyectos propios o colaborativos.  
- Construir repositorios limpios, bien documentados y de calidad.  
- Colaborar, mostrar lo que hago y seguir mejorando.  
